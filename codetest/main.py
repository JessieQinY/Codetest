...
def get_all_model():
    """Return all models code and name as a two-dimensional list"""
    model_list = []
...
def get_perf(model_list):
    ...
    model_list.insert(0, ['Code', 'Model', 'Firewall Throughput',
                          'VPN Throughput', 'AV Throughput', 'IPS Throughput',
...
def my_sort(m_list):
    """Sort list by Firewall Throughput"""
    pattern = r'([\d\.]+|[a-zA-Z]+)'
